...
## [3.0.0](https://github.com/dnwjn/nova-button/compare/2.1.1...3.0.0)

### Breaking changes

- The `ButtonClick` event now receives `$key` first and optionally `$resource` second.
  - `$resource` is now of type `\Illuminate\Database\Eloquent\Model|null`.
...
- Allow for empty resource in ButtonClick event [`#17`](https://github.com/dnwjn/nova-button/issues/17) (thanks [@KasparRosin](https://github.com/KasparRosin))
